...
def _payload(tier: str = "diagnostic") -> dict:
    ...
    return {
        ...
        "clock": {
            "schema_version": "research.clock.v1", "timezone": "UTC",
            ...
            "timing_policy_id": "t", "trading_calendar_ref": "cal",
        },
...
def test_provenance_round_trip() -> None:
    ...
    payload["provenance"] = dict.fromkeys(
        ("data_vintage", "calendar_version", "strategy_version", "engine_version",
         "execution_policy", "cost_model", "random_seed"), "v"
    )
